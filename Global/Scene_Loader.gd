...
enum Scenes {
	...
	GAME,
	GAME_TWO,
	MIMI_BOSS_CUT_SCENE_START,
	MIMI_BOSS_END_CUT_SCENE,
	MIMI_BOSS_SCENE,
	THE_DEATH
}
...
func _load_scene():
	...
	level_dict[Scenes.MIMI_BOSS_CUT_SCENE_START]			= "res://Main/Entities/MagmaMiniBoss_enemy/scene_mini_boss_start.tscn"
